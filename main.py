...
class Bahia:
    ...
    def input_usuario(self):
        ...
        self.elementos[1]["Descripcion"] = self.get_text_from_dict(self.dict_df)
        self.elegir_tt()
    ...
    def get_text_from_dict(self, dict_df):
    ...
    def dibujar(self):
        ...
        for i, instance in enumerate(self.elementos):
            ...
            if block_name in listado:
                ...
                acad.model.AddMText(APoint(instance.get("x") + separacion_derecha_eje + self.p0[0], instance.get("y") + 3, 0), defined_width, block_name)
                acad.model.AddMText(APoint(instance.get("x") + separacion_derecha_eje + self.p0[0], instance.get("y") - (i + 1) * 3, 0), defined_width, instance.get("Descripcion"))

    def clear_autocad(self):
        """Clear all objects in the AutoCAD model space."""
        try:
            acad = Autocad(create_if_not_exists=True, visible=True)
            doc = acad.ActiveDocument
